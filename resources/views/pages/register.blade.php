        ...
        <div class="w-full max-w-md">
            ...
            <div class="rounded-2xl ring-1 ring-white/10 bg-white/10 supports-[backdrop-filter]:bg-white/5 backdrop-blur-md shadow-xl p-5 sm:p-6 md:p-7">
                ...
                <form id="registerForm">
                    ...
                    <div class="space-y-4">
                        <div class="mb-2">
                            <label  title="username" for="username" class="block text-sm font-medium text-gray-300 mb-2">Имя пользователя</label>
                            <input
                                id="username"
                                name="username"
                                type="text"
                        ...
                        <div class="mb-2">
                            <label title="email"  for="email" class="block text-sm font-medium text-gray-300 mb-2">Электронная почта</label>
                            <input
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <div class="mb-2">
                            <label title="phone"  for="phone" class="block text-sm font-medium text-gray-300 mb-2">Телефон (необязательно)</label>
                            <input
                                id="phone"
                                name="phone"
                                type="tel"
                        ...
                        <div class="mb-2">
                            <label title="password"  for="password" class="block text-sm font-medium text-gray-300 mb-2">Пароль</label>
                            <input
                                id="password"
                                name="password"
                                type="password"
                        ...
                        <div class="mb-2">
                            <label title="password_confirmation"  for="password_confirmation" class="block text-sm font-medium text-gray-300 mb-2">Подтверждение пароля</label>
                            <input
            ...
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (!contentType || !contentType.includes('application/json')) {
                        ...
                        alert('Ошибка сервера. См. консоль.');
                        return;
                    }
